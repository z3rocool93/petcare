            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex items-center space-x-2 md:order-3 md:w-1/4 justify-end">
                    @if (Route::has('login'))
                        ...
                        @else
                            <a href="{{ route('login') }}" class="text-gray-800 dark:text-white hover:bg-gray-50 font-medium rounded-lg text-sm px-3 py-2">
                                Log in
                            </a>
            ...
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div class="mr-auto place-self-center lg:col-span-7">
                    ...
                    <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                        ...
                        <a href="{{ route('services.info') }}" class="bg-zinc-100 text-zinc-900 px-6 py-3 rounded-2xl font-bold hover:bg-zinc-200 transition text-center">
                            Ver servicios
                        </a>
                    </div>
                </div>
